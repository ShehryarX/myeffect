        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <View style={styles.loginbtnContainer}>
                    ...
                    <View style={{ marginLeft: wp('33%'), hrowConatiner3ight: 10, marginTop: 10 }}>
                ...
                <View style={styles.content}>
                    ...
                    <Row dial={0} flex>
                        ...
                        <View style={styles.mainContainer}>
                            ...
                            <Text style={{ color: '#215BA4', fontSize: wp("3%"), marginTop: wp("25%"), marginLeft: wp("2.3%") }}>Social Works</Text>
                        </View>
                    </Row>
                    {/* Second row */}
                    <Row dial={1} flex>
                        <View>
                            ...
                            <Text style={{ color: '#215BA4', fontSize: wp("3%"), marginTop: wp("25%"), marginLeft: wp("1.5%") }}>Happy Hippie</Text>
                        </View>
                        <View style={styles.mainContainer}>
                            <View style={styles.rowConatiner2}>
                                <Image source={require('./img/youth.png')} style={{ width: wp('20%'), height: wp("20%"), marginTop: wp("0.1%"), marginLeft: wp("0.1%"), borderRadius: 150 }} />
                            </View>
                            <Text style={{ color: '#215BA4', fontSize: wp("3%"), marginTop: wp("25%"), marginLeft: wp("1%") }}>Youth Council</Text>
                        </View>
                        <View style={styles.mainContainer}>
                            <View style={styles.rowConatiner2}>
                                <Image source={require('./img/wish.png')} style={{ width: wp('20%'), height: wp("20%"), marginTop: wp("0.1%"), marginLeft: wp("0.1%"), borderRadius: 150 }} />
                            </View>
                            <Text style={{ color: '#215BA4', fontSize: wp("3%"), marginTop: wp("25%"), marginLeft: wp("1.7%") }}>Make-A-Wish{"\n"}  Minnesota</Text>
                        </View>
                    </Row>
                    {/* Third row */}
                    <Row dial={2} flex>
                        <View style={styles.mainContainerOcean}>
                            ...
                            <Text style={{ color: '#215BA4', fontSize: wp("3%"), marginTop: wp("25%"), marginLeft: wp("-8%") }}>Save the     {"\n"} Oceans</Text>
                        </View>
                        <View style={styles.mainContainer3}>
                            ...
                            <Text style={{ color: '#215BA4', fontSize: wp("3%"), marginTop: wp("25%"), marginLeft: wp("6.3%") }}> YOU{"\n"}Effect       </Text>
                        </View>
                        <View style={styles.mainContainer4}>
                            ...
                            <Text style={{ color: '#215BA4', fontSize: wp("3%"), marginTop: wp("25%"), marginLeft: wp("1.5%") }}>Ecclesiastical{"\n"}     Calgary</Text>
                        </View>
                    </Row>
                    {/* Row 4 */}
                    <Row dial={1} flex>
                        <View>
                            ...
                            <Text style={{ color: '#215BA4', fontSize: wp("3%"), marginTop: wp("25%"), marginLeft: wp("3.8%") }}>Triathlon for {"\n"}   Change</Text>
                        </View>
                        <View style={styles.mainContainertdsb}>
                            <View style={styles.rowConatiner4}>
                                <Image source={require('./img/tdsb.png')} style={{ width: wp('20%'), height: wp("20%"), marginTop: wp("0.1%"), marginLeft: wp("0.1%"), borderRadius: 150 }} />
                            </View>
                            <Text style={{ color: '#215BA4', fontSize: wp("3%"), marginTop: wp("25%"), marginLeft: wp("8.1%") }}>TDSB    </Text>
                        </View>
                        <View style={styles.mainContainerSleepCountry}>
                            <View style={styles.rowConatiner4}>
                                <Image source={require('./img/country.png')} style={{ width: wp('20%'), height: wp("20%"), marginTop: wp("0.1%"), marginLeft: wp("0.1%"), borderRadius: 150 }} />
                            </View>
                            <Text style={{ color: '#215BA4', fontSize: wp("3%"), marginTop: wp("25%"), marginLeft: wp("6.5%") }}>  Sleep{"\n"}Country</Text>
                        </View>
                    </Row>
                    <View>
